...
export const sharethreetextcard: textCardType[] = [
  {
    id: "0",
    title: "벡터 스타터share",
    content:
...
export const sharetwo: TextDataItem[] = [
  {
    id: "section2",
...
export const shardcarddata: CarddataType[] = [
  {
    id: "0",
    title: "3D 디자인 만들기reality",
    content:
      "장면을 구축하고, 3D 자산을 만들거나 가져오고, 재료를 조정하고, 반응형 트리거가 될 수 있는 그래픽 요소를 추가하는 디자인 모드에서 프로젝트를 시작하세요.",
    img: "https://assets-global.website-files.com/636cc984003871e3cda597bb/650d8421e976aeb3065ffeb8_Improve%20teamwork%20with%20one%20link%20sharing%20(1).png",
    type: "imgright",
  },
  {
    id: "1",
    ...
    content:
      "장면을 구축하고, 3D 자산을 만들거나 가져오고, 재료를 조정하고, 반응형 트리거가 될 수 있는 그래픽 요소를 추가하는 디자인 모드에서 프로젝트를 시작하세요.",
    img: "https://assets-global.website-files.com/636cc984003871e3cda597bb/64e8ae125a7de4077861aaa0_Embed%20your%20designs.png",
    type: "imgleft",
  },
  {
    id: "0",
...
export const sharetextcard: maincardDataType[] = [
  {
    id: "0",
    subtitle: "share1",
    secSubtitle: "3D configurators",
...
export const sharetextdata: TextDataItem[] = [
  {
    id: "section1",
