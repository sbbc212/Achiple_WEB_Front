...
export const workflowdData: maincardDataType[] = [
  {
    id: "0",
    subtitle: "워크플로우",
...
export const workFlowTextCardData: textCardType[] = [
  {
    id: "0",
    title: "매우 효과적인 커뮤니케이션",
    content:
...
export const workFlowCarddata: CarddataType[] = [
  {
    id: "0",
    title: "데이터는 우리에게 안전합니다",
    content: "Vectary는 수천 개의 회사로부터 신뢰를 받고 있습니다.",
...
export const workFlowCardData: maincardDataType[] = [
  {
    id: "0",
    subtitle: "산업1",
    secSubtitle: "패션1",
