...
function BgBanner() {
  return (
    <div style={{ marginBottom: "60px" }} className="layout p-16 text-white rounded-lg h-[400px] ">
      <div
        className="h-full bg-cover bg-no-repeat bg-center flex justify-center flex-col items-center gap-y-8 rounded-2xl overflow-hidden"
